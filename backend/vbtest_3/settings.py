"""
Django settings for vbtest_3 project.
...
WSGI_APPLICATION = 'vbtest_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vbtest_3 API",
    "DESCRIPTION": "API documentation for vbtest_3 App",
    "VERSION": "v1",
}
